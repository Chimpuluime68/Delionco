...
export const navItems = [
  { name: "Home", href: "index.html" },
  {
    ...
    dropdown: [
      ...
      { name: "Automated Gate Openers", href: "Automated_Gate_Opener.html" },
      {
        name: "Smart Hotel & Facial Looks",
        href: "Smart_Looks.html",
      },
      ...
      {
        name: "4G Truck Cameras & Spy Cameras",
        href: "4G.html",
      },
      {
...
// solar cctv
export const solar_list = [
  {
    head: "Solar CCTV",
    discription: "box Single lens 4G Camera",
    pricing: "   Get best price",
    img: "./image/categories-01.jpg",
